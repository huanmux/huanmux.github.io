...
export function getMarkdownPageBySlug(rawSlug: string): MarkdownPageData | null {
  ...
  const aliasMap: Record<string, string> = {
    ...
    'jest-js': 'jest',
    'jestjs': 'jest',
    'langchain-comparison': 'langchain-vs-langgraph-vs-langsmith-vs-langflow-vs-langfuse',
    'langchain-ecosystem': 'langchain-vs-langgraph-vs-langsmith-vs-langflow-vs-langfuse',
    'langchain-vs-langgraph': 'langchain-vs-langgraph-vs-langsmith-vs-langflow-vs-langfuse',
    'langsmith-vs-langfuse': 'langchain-vs-langgraph-vs-langsmith-vs-langflow-vs-langfuse',
    'langgraph-langsmith-langfuse': 'langchain-vs-langgraph-vs-langsmith-vs-langflow-vs-langfuse',
    'langchain': 'langchain-vs-langgraph-vs-langsmith-vs-langflow-vs-langfuse',
    'langgraph': 'langchain-vs-langgraph-vs-langsmith-vs-langflow-vs-langfuse',
    'langsmith': 'langchain-vs-langgraph-vs-langsmith-vs-langflow-vs-langfuse',
    'langflow': 'langchain-vs-langgraph-vs-langsmith-vs-langflow-vs-langfuse',
    'langfuse': 'langchain-vs-langgraph-vs-langsmith-vs-langflow-vs-langfuse',
  };
